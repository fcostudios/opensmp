...
const capacityRecoveryTableName = "capacity_recovery_work";

export const capacityRecoveryWork = pgTable(capacityRecoveryTableName, {
  id: uuid("id").primaryKey().defaultRandom().notNull(),
  idempotencyKey: text("idempotency_key").notNull().unique(),
...
// @ts-ignore -- Drizzle Kit's TypeScript loader requires the extensionless source specifier.
export * from "./connector-call-observations";

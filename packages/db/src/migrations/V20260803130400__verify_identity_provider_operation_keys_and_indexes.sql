DO $verify_identity_provider_operation_keys_and_indexes$
DECLARE
  actual jsonb;
BEGIN
  ...
  IF actual <> '[
    ...
    RAISE EXCEPTION 'identity provider operation index contract mismatch: %', actual;
  END IF;
END
$verify_identity_provider_operation_keys_and_indexes$;

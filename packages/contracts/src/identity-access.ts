...
export const disableUserAccountInputSchema = z.object({
...
export const resetTwoFactorInputSchema = z.object({
  userAccountId: userAccountIdSchema,
  note: auditNoteSchema,
});
...
export const grantCompanyRoleInputSchema = z
  .object({
    userAccountId: userAccountIdSchema,
...
export const removeCompanyRoleInputSchema = z.object({
